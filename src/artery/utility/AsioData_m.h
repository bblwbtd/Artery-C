...
/**
 * Class generated from <tt>/home/chenjienan/Artery-C/src/artery/utility/AsioData.msg:30</tt> by opp_msgtool.
 * <pre>
 * message AsioData
 * {
 *     //  AsioBuffer Buffer;
...
template<> inline AsioData *fromAnyPtr(any_ptr ptr) { return check_and_cast<AsioData*>(ptr.get<cObject>()); }
